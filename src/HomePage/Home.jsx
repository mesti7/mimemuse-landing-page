...
export const Home = () => {
  ...
  return (
    <div className=" bg-gray-900">
      <NavBar />
      <div
        className=" w-full h-screen p-8 bg-cover bg-center flex justify-center items-center  "
        style={{ backgroundImage: `url(${hero})` }}
      >
        <div className=" grid grid-cols-2 lg:grid-cols-3 bg-gray-900 rounded-[45px] p-11 gap-6 xl:py-12">
          <div className="grid col-span-2">
            <h1 className=" text-left text-4xl md:text-6xl font-bold bg-gradient-to-br  from-red-500 to-blue-500 text-transparent bg-clip-text ">
              Ready to Study Aboard
            </h1>
            <h3 className=" text-left text-2xl pt-4 text-white ">
              Lets get started
            </h3>
          </div>
