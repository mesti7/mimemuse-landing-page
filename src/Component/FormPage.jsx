...
function FormPage() {
  ...
  return (
    <>
      <div>
        <div className=" min-h-screen w-full flex-1 md:grid place-items-center">
          <div className="bg-white rounded-md shadow-md grid grid-cols-1 md:grid-cols-2 m-10">
            {/* contact information */}
            <div
              className="bg-gradient-to-br from-orange-500 to-orange-400 p-8 rounded-md transition px-6 py-4"
              id="contact_info"
            >
              ...
              <div className="mt-6">
                ...
                <div>
                  ...
                  <p className="text-white text-lg">cyrilindustry@gmail.com</p>
                </div>
              </div>
              <div className="mt-6 ">
                <div>
                ...
                <div>
                  ...
                  <p className="text-white text-lg">+44 7767 796768</p>
                </div>
              </div>
                ...
                <form ref={form} onSubmit={sendEmail}>
                  <div className="grid lg:flex justify-between gap-2">
                    <input
                      ...
                      className="w-full text-xs px-3 h-8 my-2 outline-none rounded-md border focus:shadow-sm text-black"
                    />
                    <input
                      type="text"
                  ...
                  <div className="grid lg:flex justify-between gap-2 mt-2">
                    ...
                    <input
                      ...
                      className="w-16 text-xs px-3 h-8 my-2 outline-none rounded-md border focus:shadow-sm text-black"
                    />
                    <input
                      type="text"
                      placeholder="Phone Number"
                  ...
                  <div className="grid lg:flex justify-between gap-2">
                    <select
                      ...
                      id="country_id"
                      className="form-control w-full text-xs px-3 h-8 my-2 outline-none rounded-md border focus:shadow-sm resize-none text-black"
                    >
                  ...
                  <textarea
                    ...
                    name="message"
                    className="w-full text-xs px-3 py-2 h-20 my-2 outline-none rounded-md border focus:shadow-sm resize-none text-black"
                  ></textarea>
                  <br />
                  <input
                    type="submit"
                    value="send"
                    className="bg-orange-500 px-4 py-2 rounded-md text-white text-xs cursor-pointer hover:shadow-md"
                  />
                  {isMessageSent && (
